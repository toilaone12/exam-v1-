...
<body>
    <div class="position-relative overflow-hidden">
        <div class="detail">
            <div class="container">
                <form method="POST" action="finish.php?id=<?=$row['id']?>" id="finish-exam">
                    <!-- <input type="hidden" name="idExam" value="<?=$id?>"> -->
                    <div class="row">
                            ...
                            <div class="exam-detail-block">
                                ...
                                <div class="exam-detail-countdown">
                                    <ul class="d-flex justify-content-center">
                                        ...
                                        <li>
                                            <span id="minutes" class="exam-detail-number"><?=$row['duration'] < 10 ? '0'.$row['duration'] : $row['duration'] ?></span>
