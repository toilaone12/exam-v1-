                  ...
                  ?>
                    <div class="product_list col-lg-6">
                      <div class="card mb-3" style="max-width: 800px;">
                        <div class="row ">
                          <div class="col-md-4">
                            <img src="./public/img/<?php echo $fetch_product['image']; ?>" class="img_card img-fluid rounded-start" alt="...">
                          </div>
                          <div class="col-md-8">
                            <div class="card-body">
                ...
                <?php
                  ...
                  <div class="product_list col-lg-6">
                    <div class="card mb-3" style="max-width: 800px;">
                      <div class="row ">
                        <div class="col-md-4">
                          <img src="./public/img/gd.jpg" class="img_card img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-8">
                          <div class="card-body">
