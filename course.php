    ...
    <div class="container container_hero mt-2">
        <div class="card_top mb-3">
            <div class="row">
                ...
                <img src="./public/img/khttn.png" class="img_card img-fluid rounded-start" alt="...">
                </div>
            </div>
        </div>
